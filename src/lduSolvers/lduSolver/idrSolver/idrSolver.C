...
Foam::scalar Foam::idrSolver::vscal(const scalar *a, const scalar *b, label size) const
{
...
Foam::scalar Foam::idrSolver::scal(const scalar *a, const scalar *b, label size) const
{
